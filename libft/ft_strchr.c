...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/26 07:43:54 by cmichele          #+#    #+#             */
/*   Updated: 2026/06/26 07:44:00 by cmichele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("\n\n\nthe return (pointer from my strchr :
		%p\n",ft_strchr(string,c)));
	printf("the return (pointer from real strchr :
		%p\n\n\n\n\n\n\n",strchr(string,c)));
		for (size_t i = 0; i < sizeof(string); i++)
	{
