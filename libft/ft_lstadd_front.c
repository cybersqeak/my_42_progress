...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/26 07:35:42 by cmichele          #+#    #+#             */
/*   Updated: 2026/06/26 07:35:44 by cmichele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("the address of nw's next->content address is
		%p\n",new->next->content);
	printf("the address of nw's next->content->next is
		%p\n",(void*)new->next->next);
	return (0);
}
*/
